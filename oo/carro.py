""""Você deve criar uma classe carro que vai possuir dois outros atributos compostos por outras duas
classes:
1) Motor
2) Direção
...
1) Valode de direção com valores posíveis: norte, sul, leste, oeste
